...
from database.prompt_repo import AsyncSessionLocal # Reutilizar a sessionmaker
            ...
            try:
                ...
                result = await session.execute(
                    query,
                    {
                        ...
                        "tipo": parameter_data.tipo.value
                    }
                )
                ...
                if created_row:
                    return ParameterResponse(
                        ...
                        tipo=TipoParametroEnum(created_row[4])
                    )
                return None
            ...
            try:
                ...
                if not update_fields:
                    return ParameterResponse(
                        ...
                        descricao=current_param[3], tipo=TipoParametroEnum(current_param[4])
                    )
                ...
                if updated_row:
                    return ParameterResponse(
                        ...
                        descricao=updated_row[3], tipo=TipoParametroEnum(updated_row[4])
                    )
                return None
            except SQLAlchemyError as e:
                await session.rollback()
